import { css as D, createStitches as n1, createTheme as s1 } from "@stitches/core";
import { generateClassNames as V, VIEWS as p, template as c1, merge as W, en as i1, PREPENDED_CLASS_NAMES as a1 } from "@supabase/auth-ui-shared";
...
function X({
  ...
  var x;
  const [E, C] = u(""), [w, d] = u(""), [a, m] = u(""), [c, y] = u(!1), _ = async (h) => {
    var s;
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: _ }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: o }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "email", appearance: o }, i == null ? void 0 : i.email_input_label), /* @__PURE__ */ e.createElement(
    B,
    {
      id: "email",
      name: "email",
    ...
    I,
    {
      href: "#auth-sign-in",
      onClick: (h) => {
        h.preventDefault(), t(p.SIGN_IN);
      },
      appearance: o
    },
    (x = r == null ? void 0 : r.sign_in) == null ? void 0 : x.link_text
  ), a && /* @__PURE__ */ e.createElement(N, { appearance: o }, a), w && /* @__PURE__ */ e.createElement(N, { color: "danger", appearance: o }, w)));
}
const L = D({
  width: "21px",
  height: "21px"
...
function V1({
  ...
  const [a, m] = u(!1), [c, y] = u(""), _ = l === "vertical", i = C === "magic_link" ? "sign_in" : C, x = async (g) => {
    m(!0);
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, n && n.length > 0 && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: d }, /* @__PURE__ */ e.createElement(
    z,
    {
    ...
    n.map((g) => {
      ...
      return /* @__PURE__ */ e.createElement(
        A,
        {
          key: g,
          color: "default",
          icon: s ? /* @__PURE__ */ e.createElement(s, null) : "",
          loading: a,
          onClick: () => x(g),
          appearance: d
        },
...
function Q({
  ...
  var T, G, Z, j;
  const _ = m1(!0), [i, x] = u(l), [h, g] = u(n), [s, M] = u(""), [b, $] = u(!1), [P, U] = u("");
  R(() => (_.current = !0, x(l), g(n), () => {
    _.current = !1;
  }), [t]);
  const O = async (S) => {
    var q;
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(z, { direction: "vertical", gap: "large", appearance: c }, /* @__PURE__ */ e.createElement(z, { direction: "vertical", gap: "large", appearance: c }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "email", appearance: c }, f == null ? void 0 : f.email_label), /* @__PURE__ */ e.createElement(
      B,
      {
        id: "email",
        type: "email",
    ...
    ), C && /* @__PURE__ */ e.createElement(z, { direction: "vertical", gap: "small", appearance: c }, t === p.SIGN_IN && a && /* @__PURE__ */ e.createElement(
      I,
      {
        href: "#auth-magic-link",
        onClick: (S) => {
          S.preventDefault(), r(p.MAGIC_LINK);
        },
        appearance: c
      },
      ...
      I,
      {
        ...
        onClick: (S) => {
          S.preventDefault(), r(p.FORGOTTEN_PASSWORD);
        },
        appearance: c
      },
      ...
      I,
      {
        href: "#auth-sign-in",
        onClick: (S) => {
          S.preventDefault(), F(p.SIGN_IN);
        },
        appearance: c
      },
      (j = m == null ? void 0 : m.sign_in) == null ? void 0 : j.link_text
    ))),
    P && /* @__PURE__ */ e.createElement(N, { appearance: c }, P),
    s && /* @__PURE__ */ e.createElement(N, { color: "danger", appearance: c }, s)
  );
}
function e1({
  setAuthView: t = () => {
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-forgot-password", onSubmit: _ }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: o }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "email", appearance: o }, i == null ? void 0 : i.email_label), /* @__PURE__ */ e.createElement(
    B,
    {
      id: "email",
      name: "email",
...
function t1({
  ...
  const [r, o] = u(""), [v, E] = u(""), [C, w] = u(""), [d, a] = u(!1), m = async (y) => {
    var i;
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-update-password", onSubmit: m }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: n }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "password", appearance: n }, c == null ? void 0 : c.password_label), /* @__PURE__ */ e.createElement(
    B,
    {
      id: "password",
      name: "password",
  ...
  ), C && /* @__PURE__ */ e.createElement(N, { appearance: n }, C), v && /* @__PURE__ */ e.createElement(N, { color: "danger", appearance: n }, v)));
}
function A1({
  setAuthView: t = () => {
  },
  ...
  var M;
  const [E, C] = u(""), [w, d] = u(""), [a, m] = u(""), [c, y] = u(""), [_, i] = u(""), [x, h] = u(!1), g = async (b) => {
  ...
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: g }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: o }, ["sms", "phone_change"].includes(n) ? /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "phone", appearance: o }, s == null ? void 0 : s.phone_input_label), /* @__PURE__ */ e.createElement(
    ...
    I,
    {
      href: "#auth-sign-in",
      onClick: (b) => {
        b.preventDefault(), t(p.SIGN_IN);
      },
      appearance: o
    },
    (M = r == null ? void 0 : r.sign_in) == null ? void 0 : M.link_text
  ), _ && /* @__PURE__ */ e.createElement(N, { appearance: o }, _), c && /* @__PURE__ */ e.createElement(N, { color: "danger", appearance: o }, c)));
}
const l1 = d1({ user: null, session: null }), U1 = (t) => {
...
function k({
  ...
  const x = W(i1, c.variables ?? {}), [h, g] = u(v), [s, M] = u(""), [b, $] = u(""), P = h === "sign_in" || h === "sign_up" || h === "magic_link";
  R(() => {
    var F, f;
    n1({
      theme: W(
...
), K1 = (t) => /* @__PURE__ */ e.createElement(k, { ...t, view: "magic_link", showLinks: !1 }), Y1 = (t) => /* @__PURE__ */ e.createElement(
  k,
  {
    ...t,
    view: "sign_in",
...
), J1 = (t) => /* @__PURE__ */ e.createElement(k, { showLinks: !1, ...t, view: "forgotten_password" }), Q1 = (t) => /* @__PURE__ */ e.createElement(k, { ...t, view: "update_password" }), X1 = (t) => /* @__PURE__ */ e.createElement(k, { ...t, view: "verify_otp" });
export {
  k as Auth,
  Z1 as AuthCard,
  J1 as ForgottenPassword,
  K1 as MagicLink,
  q1 as SignIn,
  j1 as SignUp,
  Y1 as SocialAuth,
  Q1 as UpdatePassword,
  X1 as VerifyOtp
};
