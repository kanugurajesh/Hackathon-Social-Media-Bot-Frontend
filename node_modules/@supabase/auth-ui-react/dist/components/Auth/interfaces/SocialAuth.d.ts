...
declare function SocialAuth({ supabaseClient, socialLayout, providers, providerScopes, queryParams, redirectTo, onlyThirdPartyProviders, view, i18n, appearance, }: SocialAuthProps): JSX.Element;
export { SocialAuth };
